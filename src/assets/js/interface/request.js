...
var arr = [
    ...
    'carInsuranceLoanInfo', //分期借款信息
    'bindBankCardList', //获取银行卡列表
    'bankList', //银行列表
    'bankCardBindPre', //预绑卡
    'bankCardBind', //绑定银行卡
    'userContactList', //获取联系人
    'carInstallmentApply', //分期申
    'loanOrderDetail', //还款详情
    'bindBankCardList', //我的银行卡
    'idCardMesInfo' //银行卡联系人
];
let request = {}
arr.map((item, key) => {
...
function post(obj, fn, errFn) {
    ...
    axios.post(obj.url, {
        ...
        /** 参数错误 */
        // public static final String CODE_FAILD_PARAM_CHECK = "100103";
        // /** 验签失败 */
        // public static final String CODE_FAILD_SIGN_CHECK = "100104";
        // /** 动态密码错误 */
        // public static final String CODE_FAILD_DYNAMIC_PASSWORD = "100105";
        // /** 会话过期 */
        // public static final String CODE_FAILD_SESSION_EXPIRED = "100106";
        // /** 用户未登录，但当前操作要求登录 */
        // public static final String CODE_FAILD_NEED_LOGIN = "100107";
        // console.log(response.data)
        //100107 会话超时
        // response.data.respCode === '100106' ||会话过期
        // if (response.data.respCode === '100107') {
