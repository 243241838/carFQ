    ...
    <div id="body">
        <div class="content" v-show="!loading">
            ...
            <div class="description" v-if="output.tips">
                ...
                <div class="content phone">联系电话：400-110-1866</div>
            </div>
...
export default {
    ...
    methods: {
        ...
        gotoDispatch () {
            ...
            // window.location.href = 'FQcarStages.html?tradeId=' + Common.getQueryString('tradeId');
            this.showtoast('该保单已提交分期申请', true);
        ...
        // 分期查询
        divideDetail () {
            window.location.href = 'FQcarStagesDetil.html?tradeId=' + Common.getQueryString('tradeId');
            // let obj = {
            //     userId: Common.getUserId(),
            //     tradeId: Common.getQueryString('tradeId')
            // }
