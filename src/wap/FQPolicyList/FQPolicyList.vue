    ...
    <div class="container">  
        <div id="body" class="body" >
            ...
            <div class="list" :class="{isWeiXin:isWeiXin}">
                ...
                <!--
                repaymentStatus;
                ////车险分期订单还款状态  状态，-10已删除  10 未放款 11 正常还款中 12 已结束 13 逾期 add by ccd
                instalmentSts;
                // add ccd '分期状态。00：无分期，10：分期申请中，-10：分期取消，20：分期审核中，30：分期审核通过，-20：分期申请失败，-30：分期审核失败',
                -->
                <div v-for="(item,index) in output" >
                    ...
                    <div class="item">
                        ...
                        <div class="center" @click="goUrl(item)" :class="{past:item.sts>20}">
                            <div>
                                <div>
                                    车牌号：
                        ...
                        <div class="bottom flexbox" :class="{past:item.sts>20}">
                            ...
                            <div class="flex flexbox justify-content flex-right " @click="goUrl(item, 1)" v-show="item.instalmentSts != 10 && item.instalmentSts != 00">
                                <span v-show="item.repaymentStatus == 11">待还款</span>
                                <span v-show="item.repaymentStatus == 12">已结清</span>
                                <span v-show="item.repaymentStatus == 13">已逾期</span>
